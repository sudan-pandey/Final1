        ...
        <?php else: ?>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <h5>Total Members</h5>
                    <div class="value" data-stat="total_members"><?php echo $totalMembers; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="value" data-stat="upcoming_events"><?php echo $upcomingEvents; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <h5>Pending Tasks</h5>
                    <div class="value" data-stat="pending_tasks"><?php echo $pendingTasks; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <h5>In Progress</h5>
                    <div class="value" data-stat="in_progress_tasks"><?php echo $inProgressTasks; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <h5>Completed</h5>
                    <div class="value" data-stat="completed_tasks"><?php echo $completedTasks; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <h5>Overdue Tasks</h5>
                    <div class="value" data-stat="overdue_tasks" style="color: var(--danger);"><?php echo $overdueTasks; ?></div>
                </div>
            </div>
