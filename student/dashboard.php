        ...
        <?php if ($membership): ?>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <h5>Pending Tasks</h5>
                    <div class="value" data-stat="pending_tasks"><?php echo $pendingTasksCount; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="value" data-stat="progress_tasks"><?php echo $progressTasksCount; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="value" data-stat="completed_tasks"><?php echo $completedTasksCount; ?></div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="value" data-stat="upcoming_events"><?php echo $upcomingEventsCount; ?></div>
                </div>
            </div>
        <?php else: ?>
