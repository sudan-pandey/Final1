    ...
    <main class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="value" data-stat="total_users"><?php echo $totalUsers; ?></div>
            </div>
            <div class="stat-card">
                ...
                <h5>Total Clubs</h5>
                <div class="value" data-stat="total_clubs"><?php echo $totalClubs; ?></div>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <h5>Total Events</h5>
                <div class="value" data-stat="total_events"><?php echo $totalEvents; ?></div>
            </div>
            <div class="stat-card">
                ...
                <div class="value" data-stat="total_tasks"><?php echo $totalTasks; ?></div>
            </div>
            <div class="stat-card">
                ...
                <h5>Feedbacks</h5>
                <div class="value" data-stat="total_feedback"><?php echo $totalFeedback; ?></div>
            </div>
        </div>
